 ...
 * Amplitude Hooks
 * 
 * React Query hooks for fetching Amplitude analytics data
 */
...
export const useAmplitudeMetrics = (params?: Record<string, any>) => {
    return useQuery({
...
export const useAmplitudeEvents = (params?: Record<string, any>) => {
    return useQuery({
...
export const useAmplitudeSessionReplays = (params?: Record<string, any>) => {
    return useQuery({
...
export const useAmplitudeCohorts = (params?: Record<string, any>) => {
    return useQuery({
