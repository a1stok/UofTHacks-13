...
import { PuckComponent, RichText, Slot } from "@measured/puck/types";
import { trackSectionView, trackButtonClick } from "../../../lib/amplitude";
...
export const Hero: PuckComponent<HeroProps> = ({
  ...
  const handleButtonClick = (button: any, index: number) => {
    trackButtonClick(button.label, `hero-button-${index}`);
  };
